...
public class MainActivity extends ActionBarActivity {
    ...
    public class RubyCommitAdapter extends ArrayAdapter<JSONArray>{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(row == null)
            {
                ...
                // Let's not slavishly follow Web Tutorials. We can be dynamic.
            ...
            try {
                // I could extend JSONObject to handle dotted names ... nah.
    ...
    private class GetRubyCommitsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            RubyCommitAdapter adapter = new RubyCommitAdapter(mActivity,
                    R.layout.listview_item_row, jArray);
    ...
    public class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mTv = (TextView) rootView.findViewById(R.id.text_view);
